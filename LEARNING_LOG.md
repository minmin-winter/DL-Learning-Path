...
## 📆 2025-12-28 Sun. | Day 11: 调整与再出发

### ☁️ 碎碎念

在进入Huggingface的Trasformers库的学习之后，基本上AI给的教学都是复制粘贴运行，就这样过完全量微调，LoRA,RAG之后，我还是决定痛定思痛，在进入Transformer库的学习之后，不再跟着Gemini学习，同时也决定接下来转入阅读论文。还有不到三天就要考大计基了，是时候开始复习了，同时也要搜集阅读一下如何阅读论文。之后再到寒假的这段时间里，估计就是以读论文，复现论文，并以这些为核心拓展技能树了。目前还是先读多模态相关的吧，具身的花话实在是对机器人怎么动这些不是很感兴趣
